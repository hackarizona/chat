$(function() {
    ...
    var $addCodeButton=$('#addCodeButton');
    var $hideCodeButton=$('#hideCodeButton');
    ...
    function addParticipantsMessage(data){
        var message='';
        message+="Hackers online : "+data.numUsers ;
        log(message);
    }
    ...
    $addCodeButton.click(function(){
        ...
        $addCodeButton.css("display","none");
    });
    $hideCodeButton.click(function(){
        $addCodeButton.css("display","block");
    ...
    socket.on('login',function(data){
        connected=true;
        var message="Welcome to HackAZ Chat board ";
        log(message,{
            prepend: true
        });
